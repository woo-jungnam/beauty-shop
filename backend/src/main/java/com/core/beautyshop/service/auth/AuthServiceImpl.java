...
import com.core.beautyshop.factory.UserFactory;
import com.core.beautyshop.mapper.AuthMapper;
import com.core.beautyshop.repository.RoleRepository;
import com.core.beautyshop.repository.UserRepository;
import com.core.beautyshop.security.jwt.JwtUtils;
import com.core.beautyshop.security.services.UserDetailsImpl;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        Role userRole = roleRepository.findByRoleName(com.core.beautyshop.entities.user.enums.Role.ROLE_USER.name())
                .orElseGet(() -> roleRepository.save(Role.builder()
                        .roleName(com.core.beautyshop.entities.user.enums.Role.ROLE_USER.name())
