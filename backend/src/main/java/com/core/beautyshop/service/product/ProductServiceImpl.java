...
import com.core.beautyshop.dto.response.*;
import com.core.beautyshop.entities.product.*;
...
import com.core.beautyshop.repository.*;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse createProduct(CreateProductRequest request) {
        ...
        Product product = Product.builder()
                ...
                .productType(request.getProductType() != null ? request.getProductType() : com.core.beautyshop.entities.product.enums.ProductType.PRODUCT)
